**Intro to Programming (Course from Kaggle)**
---------------------------------------------

This repository contains my personal learning code from the **Kaggle – Intro to Programming** course. It serves as a collection of exercises, notes, and hands-on practice as I build a strong foundation in Python programming. Access the course here: https://www.kaggle.com/learn/intro-to-programming
